...
> עודכן לאחרונה: 24 יוני 2026 - גרסה 1.0.9+52: polling אוטומטי ל-pending settlements (30 שניות) לסנכרון בין מכשירים; החלפת em-dashes במקפים רגילים; Firebase push מאותחל ותקין; APK build 52 ב-GitHub Releases
