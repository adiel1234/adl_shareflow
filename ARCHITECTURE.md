...
> עודכן לאחרונה: 27 יולי 2026 - גרסה 1.0.9+53: תיקון התנתקות; זכירת פרטי התחברות; WhatsApp דרך המכשיר (הזמנות, תזכורות חוב, סיכום אירוע אחד-אחד, חוב אורח) - ללא Business API
