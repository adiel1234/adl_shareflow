...
| **44** | ⏳ **בתור** | **באג join 404** (import `Expense` חסר ב-`join_group`) + **UX**: דיאלוג split_mode עובר למזמין בלבד — ג'וינר לא רואה דיאלוג | iOS + Android | `1.0.5+44` | הצטרפות דרך קישור WhatsApp → ללא דיאלוג → מצטרף ✅ |
