...
> עודכן: 27 אוגוסט 2026 · גרסה בהעלאה: **`1.0.9+80`**

## מה כבר מוכן בריפו ✅
| בדיקה | תוצאה |
|--------|--------|
| `pubspec` / AAB | `1.0.9+80` · `shareflow-1.0.9+80-CLOSED-TESTING.aab` |
...
### ב־Play Console
- [ ] Releases: מהדורה **`1.0.9 (80)`** בסטטוס Available to testers
...
- [ ] התקנה/עדכון מ־Play → פרופיל מציג **1.0.9 (80)**
