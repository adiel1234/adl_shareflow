...
def send_password_reset_email(
    *,
    ...
    subject = 'קוד לאיפוס סיסמה — ADL ShareFlow'
      ...
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#6366F1,#8B5CF6);padding:36px 32px;text-align:center;">
              <h1 style="margin:0;color:#ffffff;font-size:24px;font-weight:700;">ADL ShareFlow</h1>
              <p style="margin:8px 0 0;color:rgba(255,255,255,0.85);font-size:14px;">איפוס סיסמה</p>
            </td>
          </tr>
          <tr>
            <td style="padding:36px 32px;">
              <h2 style="margin:0 0 12px;font-size:20px;color:#1a1a2e;">שלום {safe_name},</h2>
              <p style="margin:0 0 24px;font-size:15px;color:#444;line-height:1.6;">
                קיבלנו בקשה לאיפוס הסיסמה שלך. הזן את הקוד הבא באפליקציה:
              </p>
              <div style="background:#f0f0ff;border:2px dashed #6366F1;border-radius:16px;
                          padding:24px;text-align:center;margin-bottom:24px;">
                <p style="margin:0 0 8px;font-size:13px;color:#666;">קוד איפוס</p>
                <div style="font-size:36px;font-weight:800;color:#6366F1;letter-spacing:10px;">
                  {code}
                </div>
              </div>
          ...
          <tr>
            <td style="padding:20px 32px;background:#fafafa;border-top:1px solid #eee;text-align:center;">
              <p style="margin:0;font-size:12px;color:#aaa;">ADL ShareFlow · adl.co.il</p>
            </td>
          </tr>
        </table>
      </td>
